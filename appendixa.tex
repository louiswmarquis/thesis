...
\begin{figure}[h]
    ...
    \Qcircuit @C=1em @R=1.6em {
        ...
        \lstick{} & \qw & \qw & \qw & \qw & \ghost{\substack{\ket{w}\ket{z} \rightarrow \\ \ket{w}\ket{z + w^2}}} & \gate{P(-\frac{t}{2}\lambda_r2^{2(M_r - (\frac{m}{2} - 1))})} & \qw \\
        \lstick{} & \qw & \qw & \qw & \qw & \ghost{\substack{\ket{w}\ket{z} \rightarrow \\ \ket{w}\ket{z + w^2}}} & \gate{P(-\frac{t}{2}\lambda_r2^{2(M_r - (\frac{m}{2} - 1)) + 1})} & \qw \\
        \lstick{} & & & \cdots & & \nghost{\substack{\ket{w}\ket{z} \rightarrow \\ \ket{w}\ket{z + w^2}}} & \cdots & \\
        \lstick{} & \qw & \qw & \qw & \qw & \ghost{\substack{\ket{w}\ket{z} \rightarrow \\ \ket{w}\ket{z + w^2}}} & \gate{P(-\frac{t}{2}\lambda_r2^{2M_r - 1})} & \qw \\
        \lstick{} & \qw & \qw & \qw & \qw & \ghost{\substack{\ket{w}\ket{z} \rightarrow \\ \ket{w}\ket{z + w^2}}} & \gate{P(\frac{t}{2}\lambda_r2^{2M_r + 1})} & \qw 
