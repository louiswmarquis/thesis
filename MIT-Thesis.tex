...
\hypersetup{%
	pdfsubject={Optimizing Quantum Simulation of Low-Range Electronic Structure Hamiltonians},
...
\title{Optimizing Quantum Simulation of Low-Range Electronic Structure Hamiltonians}
...
\Acceptor{Katrina LaCurts}{Chair, Master of Engineering Thesis Committee}{} % \\ \> Third title}
